...
const AvailabilityManagement = ({ onUpdate }) => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Agent Availability Management</h2>
        <p className="mt-1 text-sm text-gray-500">View all agent availability slots across the system</p>
      </div>
              ...
              <tr key={availability.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">{availability.agent?.email}</div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
